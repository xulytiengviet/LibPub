(() => {
  ...
  const messages = {
    vi: {
      ...
      "form.file": "Chọn manuscript.docx hoặc article.xml", "form.fileHint": "Tối đa 25 MB · tệp chỉ được gửi khi bấm Submit", "form.branch": "Nhánh công bố", "form.token": "Fine-grained token", "form.tokenHint": "Chỉ cần quyền Contents: read/write cho LibPub.",
    ...
    en: {
      ...
      "form.file": "Choose manuscript.docx or article.xml", "form.fileHint": "Maximum 25 MB · uploaded only after Submit", "form.branch": "Publication branch", "form.token": "Fine-grained token", "form.tokenHint": "Only Contents: read/write is required for LibPub.",
    ...
    zh: {
      ...
      "form.file": "选择 manuscript.docx 或 article.xml", "form.fileHint": "最大 25 MB · 点击提交后才会上传", "form.branch": "发布分支", "form.token": "细粒度令牌", "form.tokenHint": "仅需 LibPub 的 Contents 读写权限。",
